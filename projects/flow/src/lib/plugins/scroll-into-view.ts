  ...
  focus(id: string) {
    ...
    if (item) {
      ...
      if (x + width * this.data.flow.scale > this.data.flow.zRect.width) {
        this.data.flow.panX = -x * this.data.flow.scale + (this.data.flow.zRect.width - width);
      } else if (this.data.flow.panX + x * this.data.flow.scale < this.data.flow.zRect.width) {
        this.data.flow.panX = -x * this.data.flow.scale;
      }
      this.data.flow.panY = -y * this.data.flow.scale + (this.data.flow.zRect.height - height) / 2;
